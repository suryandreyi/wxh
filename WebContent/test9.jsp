...
#bt {
	...
	<script type="text/javascript">
		...
		function info() {
			...
			str += "</h3>";
			str += "<h3> 位置:";
			str += "[ 0.19 1.58527 438.25256 297.6285 ]";
			str += "</h3>";
			str += "<h3> 类别:";
			str += "boat";
			str += "</h3>";
			...
			str += "</h3>";
			str += "<h3> 位置:";
			str += "[ 0.25 3.61386 197.8954 5.399 ]";
			str += "</h3>";
			str += "<h3> 类别:";
			str += "horse";
			str += "</h3>";
			...
			str += "</h3>";
			str += "<h3> 位置:";
			str += "[ 67.62331 83.67729 384.8949 6.374 ]";
			str += "</h3>";
			str += "<h3> 类别:";
			str += "cow";
			str += "</h3>";
			...
			str += "</h3>";
			str += "<h3> 位置:";
			str += "[ 0.158 0.33 9.98785 448.2975 ]";
			str += "</h3>";
			str += "<h3> 类别:";
			str += "bottle";
			str += "</h3>";
			...
			str += "</h3>";
			str += "<h3> 位置:";
			str += "[ 0.4 6.850388 363.75806 325.0169 ]";
			str += "</h3>";
			str += "<h3> 类别:";
			str += "person";
			str += "</h3>";
						...
						<div class="widgetcontent">
							<div id="tabs" style="display: inline-block">
								...
								<div id="showinfo" style="display: block">
									<blockquote class="bq2 currentstatus marginbottom0">
										<h3>用例12：支持视觉数据目标提取与标注</h3>
										<h3>用例13：提取与标注的目标种类大于20类</h3>
									</blockquote>
								</div>
							</div>
							...
							<div id="tabs" style="display: inline-block">
								...
								<div id="showprocess" style="display: block">
									<blockquote class="bq2 currentstatus marginbottom0">
										<h3>1.选取20种类别以上图片作为数据集</h3>
										<h3>2.进入系统的可视化界面，选择数据集，点击上传按钮；</h3>
										<h3>3.点击查看结果按钮</h3>
									</blockquote>
								</div>
							</div>

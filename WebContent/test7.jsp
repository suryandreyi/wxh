							...
							<p>
								<label>一致性级别</label> <span class="field"> <select
									name="consistent" class="uniformselect">
										<option selected="selected" name="a">本地一致性</option>
										<option name="o">强一致性</option>
								</select>
								</span>
							</p>
							<p>
							...
							<div id="tabs" style="display: inline-block">
								...
								<div id="showinfo" style="display: block">
									<blockquote class="bq2 currentstatus marginbottom0">
										<h3>用例10：支持本地节点内快速索引本地情报产品检索时间每十万条数据小于 1 秒</h3>
									</blockquote>
								</div>
							</div>
							<div id="tabs" style="display: inline-block">
								...
								<div id="showprocess" style="display: block">
									<blockquote class="bq2 currentstatus marginbottom0">
										...
										<h3>3.在系统可视化界面，选择数据库，数据表，任务名，选择条目数为5000的样本数据，选择日志文件存储位置，选择一致性级别为本地一致性，选择结果统计为/500条，点击插入按钮</h3>
										<h3>4.点击查看结果按钮</h3>

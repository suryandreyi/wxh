...
public class SFTPUtil {
	public static void getNumConnect(SFTP s) throws Exception {
	...
	public static void getimgConnect(SFTP s) throws Exception {
		...
		// String passphrase ="path";
		/** 主机 */
		String host = "47.103.222.181";
		/** 端口 */
		int port = 22;
		/** 用户名 */
		String username = "root";
		/** 密码 */
		String password = "123456zxC620520";
	...
	public static void downimgload(String directory, String downloadFile, String saveFile) throws Exception {
		SFTP s = new SFTP();
		getNumConnect(s);// 建立连接
	...
	public static void downNumload(String directory, String downloadFile, String saveFile) throws Exception {
		SFTP s = new SFTP();
		getNumConnect(s);// 建立连接
		Session session = s.getSession();
		Channel channel = s.getChannel();
